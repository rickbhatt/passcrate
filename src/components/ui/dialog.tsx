  ...
  return (
    <FullWindowOverlay>
      <DialogPrimitive.Overlay
        className={cn(
          'absolute bottom-0 left-0 right-0 top-0 flex items-center justify-center bg-[rgba(0,0,0,0.5)] p-2',
          Platform.select({
...
function DialogContent({
  ...
  portalHost?: string;
  closeIconColor?: ColorValue | string;
}) {
  return (
      ...
      <DialogOverlay>
        <DialogPrimitive.Content
          ...
          <DialogPrimitive.Close
            ...
            hitSlop={12}>
            <DynamicIcon family="Feather" name="x" size={16} color={closeIconColor} />
...
function DialogTitle({ className, ...props }: React.ComponentProps<typeof DialogPrimitive.Title>) {
  return (
    <DialogPrimitive.Title
      className={cn('text-foreground text-lg font-sans-semibold leading-none', className)}
      {...props}
    />
  );
}
